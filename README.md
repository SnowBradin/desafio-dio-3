# desafio-dio-3
Desafio da DIO do módulo 3, curso de Java (4 módulos)
...
- Realização do projeto, solução:
Adicionei uma forma de juros ao projeto: taxa de juros (interest rate) para a conta poupanca. 
